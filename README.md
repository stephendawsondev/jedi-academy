...
|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Team       | As a team, we want to develop user stories for the project board so that tasks are clearly defined and organized.                             | User stories are created, documented, and visible on the project board.                                                                                                            |
| Designer   | As a designer, I want to create wireframes for the mini-games so that the team has a clear design reference.                                  | Wireframes are created and shared with the team, and they are reviewed and approved.                                                                                               |
| Team       | As a team, we need to source Star Wars images so that we can use them in the mini-games and storyline.                                         | A collection of sourced Star Wars images is compiled and accessible to the team.                                                                                                   |
| Team       | As a team, we need to source Star Wars sound clips so that we can enhance the game's audio experience.                                         | A collection of sourced Star Wars sound clips is compiled and accessible to the team.                                                                                              |
| Developer  | As a developer, I want to implement a cohesive visual design so that the game has a consistent look and feel.                                  | The game's visual design is implemented consistently across all screens and elements.                                                                                              |
| User/Player | As a user, I want to play a Star Wars themed memory game so that I can match pairs of images.                                                  | The memory game is playable, and users can match pairs of Star Wars themed images.                                                                                                 |
| User/Player | As a user, I can play a Whack a Droid game so that I can get the highest score possible.                                                       | The Whack a Droid game is playable, and users can achieve and track high scores.                                                                                                   |
| User/Player | As a user, I want to play a Star Wars themed Wordle game so that I can have fun guessing words.                                                | The Wordle game is playable, and users can guess words in a Star Wars themed context.                                                                                              |
| User/Player | As a user, I can have my data persist so that I can have a sense of story continuity in the game.                                              | User data persistence is implemented, allowing users to continue their game from where they left off.                                                                              |
| User/Player | As a user, I expect the 'How to Play' buttons on each game to open up so I can see the instructions on how to play the game and how the game works. | 'How to Play' buttons are functional and display the correct instructions for each game.                                                                                           |
| User/Player | As a user, when I click on the buttons throughout the website, I expect it to take me to the relevant page or part of the application.         | Navigation buttons throughout the website work correctly and take users to the intended pages or sections.                                                                         |
